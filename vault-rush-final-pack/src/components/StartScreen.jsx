...
const briefingItems = [
  ...
  },
  {
    number: '03',
    title: 'Override',
    text: 'Survive the final Power Outage and unlock the digital vault.',
  },
]
      ...
      <div className="start-layout">
        <div className="hero-copy">
          ...
          <p className="hero-description">
            A secure digital vault has entered emergency lockdown. Memorise
            the security sequences and clear all three access levels before
            the 60-second master timer reaches zero.
          </p>
